#!/bin/bash
# Phase 0 — Pre-Sprint 1 regression baseline (D1-D4, parallel submission).
#
...
#
# Usage: cd /home/nickyoungblut/dev/rust/scx && bash benchmarks/scripts/slurm_phase0_baseline.sh
...
echo "=== Phase 0: Pre-Sprint 1 Baseline — Small/Medium Datasets (D1-D4) ==="
echo "Date: $(date)"
...
ARCHIVE_ID=$(sbatch --parsable \
    ...
    --mem=4G \
    --time=00:10:00 \
    --output="benchmarks/logs/phase0_archive_%j.log" \
    --error="benchmarks/logs/phase0_archive_%j.err" \
...
echo ""
echo "For larger datasets (D5-D7), run:"
echo "  bash benchmarks/scripts/slurm_phase0_baseline_large.sh"
