...
def capture_run_provenance() -> dict[str, Any]:
    ...
    return {
        ...
        # GPU DE v3 is the unconditional default; the former
        # SCX_GPU_DE_V2/SCX_GPU_DE_V3 gates and the SCX_GPU_DE_V3_TRACE debug
        # trace were all removed. The recorded `gpu_dispatch_route` (e.g.
        # gpu_csc_v3) on each result is now the route signal — no env gate to
        # record.
    }
