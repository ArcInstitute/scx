...
pub use dispatch::{
    decode_indptr_only, decode_row_group, decode_scx1_row_range, decode_scx1_with_metadata,
    decode_shard, decode_shard_ref, decode_shard_scipy, decoded_shard_to_scipy, encode_shard,
