...
pub use gpu_diffexp::{
    build_cell_to_group_dev, build_cell_to_pool_dev, de_v2_enabled, de_v3_enabled,
    ...
    gpu_de_searchsorted_u_stat, gpu_de_tie_term, gpu_de_upload_chunk, set_de_v2_enabled_override,
    set_de_v3_enabled_override, GpuDeChunkScratch, GPU_DE_BLOCK_SORT_CAPACITY,
};
pub use gpu_graph::{
