...
For the full crate dependency graph and feature flag rules, see [docs/architecture.md § Crate Dependency Graph](../../../docs/architecture.md#crate-dependency-graph). Coding conventions live in [docs/conventions.md](../../../docs/conventions.md). Test matrix is in [docs/testing.md](../../../docs/testing.md).
