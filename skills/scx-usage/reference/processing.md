...
- `adjusted_mutual_info(labels_a, labels_b)` / `normalized_mutual_info(labels_a, labels_b)` / `adjusted_rand_index(labels_a, labels_b)` (rescaled to `[0,1]`).
