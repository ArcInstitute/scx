...
- **[PCA-DE-FIX.md](PCA-DE-FIX.md)** — Phase 4e spec: PCA covariance method, DE pre-ranking optimization, Rust-native Leiden. Root cause analysis, algorithm details, and benchmark results.
