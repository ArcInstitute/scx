...
| `"pseudobulk_means"` | `pyscx.accel.pseudobulk_means` (`gpu_dense` GPU pseudobulk / `cpu_csr`) |
| `"perturbation_metrics"` | `pyscx.accel.perturbation_metrics` (`gpu_dense` GPU pseudobulk / `cpu_csr`) |
