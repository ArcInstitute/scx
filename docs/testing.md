...
| **Training loader** | `test_training_loader.py`, `test_training_loader_pflog.py`, `test_e2e_pipeline.py`, `test_training_integration.py`, `test_scvi_integration.py`, `test_multimodal_training.py` | Dataset iteration, batch format, PFlog transforms, scVI DataModule |
...
| **Accelerators (CPU)** | `test_accel.py`, `test_accel_fused.py`, `test_accel_leiden.py`, `test_accel_pflog.py`, `test_accel_score_genes.py`, `test_accel_route_metadata.py`, `test_accel_stub_coverage.py` | PCA, kNN, UMAP, DE, Leiden, PFlog, gene scoring, route metadata, stub coverage |
