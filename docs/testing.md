...
| **Accelerators (CPU)** | `test_accel.py`, `test_accel_fused.py`, `test_accel_leiden.py`, `test_accel_pflog.py`, `test_accel_score_genes.py`, `test_accel_route_metadata.py`, `test_accel_stub_coverage.py` | PCA, kNN, UMAP, DE, Leiden, PFlog, gene scoring, route metadata, accel stub coverage |
